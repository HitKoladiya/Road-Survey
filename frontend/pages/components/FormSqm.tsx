...
const Form = (props: any) => {
    const nomes = [
        "Setting out and Working Drawing",
        "Site Clarance and grubbing",
        "Quality Control Arrangements",
        "Geometrics",
        "Earthwork and Sub-grade in Embankment/Cutting",
        "Sub-base",
        "Base Course",
        "Bituminous Base Cours",
        "Bituminous Surfacr Cours",
        "Shoulders",
        "CD Works",
        "Side Drains and Catch Water Drains",
        "Cement Concrete Pavement / Cell Filled Concrete Pavement/ Panelled Concrete Pavement/ Roller Compacted Pavement/ ICBP:",
